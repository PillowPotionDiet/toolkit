/**
 * DirectAdminAdapter - Adapter for DirectAdmin-based hosting providers
 * TO BE IMPLEMENTED IN PHASE 8
 */

const BaseAdapter = require('./BaseAdapter');

class DirectAdminAdapter extends BaseAdapter {
  ...
  async testConnection() {
    return {
      success: false,
      message: 'DirectAdmin adapter is not yet implemented. Coming in Phase 8!'
    };
  }
...
module.exports = DirectAdminAdapter;
